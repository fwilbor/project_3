  ...
  render() {
    return (
      <div className="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
        ...
        <p>
          Parents, create an account using your email and set a password that
          both you and your child will use. Then create a second guardian
          password that you alone will use to access the Parent Dashboard.
        </p>
