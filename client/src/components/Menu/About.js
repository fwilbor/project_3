                ...
                <div className="col-md-8 ml-auto mr-auto">
                  ...
                  <div className="description">
                    <div className="pull-left">
                      <h3>JBOT's vision is to build the must-have webapp for kids to LEARN, HAVE FUN, and STAY SAFE in an increasingly complex digital and social media age. Designed to supervise, manage, and protect your child's learning in a Monitored Online Learning Environment (M.O.L.E.).</h3>
